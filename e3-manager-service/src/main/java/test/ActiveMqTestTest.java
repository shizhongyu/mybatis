...
/** 
* 
* Method: testQueueProducer() 
* 
*/ 
@Test
public void testTestQueueProducer() throws Exception {
...
/** 
* 
* Method: testQueueConsumer() 
* 
*/ 
@Test
public void testTestQueueConsumer() throws Exception {
...
/** 
* 
* Method: testTopicProducer() 
* 
*/ 
@Test
public void testTestTopicProducer() throws Exception {
    //1、创建一个连接工厂对象，需要指定服务的ip及端口。
    ConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://192.168.25.129:61616");
    //2、使用工厂对象创建一个Connection对象。
    Connection connection = connectionFactory.createConnection();
...
/** 
* 
* Method: testTopicConsumer() 
* 
*/ 
@Test
public void testTestTopicConsumer() throws Exception {
    //创建一个ConnectionFactory对象连接MQ服务器
    ConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://192.168.25.129:61616");
    //创建一个连接对象
    Connection connection = connectionFactory.createConnection();
